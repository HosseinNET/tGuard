...
chats = {}
day = 86400
bot_id = 330097534 -- [[محل قرار گیری آیدی اکانت ربات]]
sudo_users = {104684115,301393805} -- [[محل قرار گیری آیدی سودو ها]]
...
دستورات بخش فیلتر کلمات :
				
افزودن عبارت جدید به لیست کلمات فیلتر شده
					
filter word
					
حذف عبارت جدید از لیست کلمات فیلتر شده
